...
`include "uvm_macros.svh"
    ...
    class wrapper_agent extends uvm_agent;
        ...
        wrapper_monitor   mon;
        wrapper_object    obj;
        uvm_analysis_port #(wrapper_sequence_item) agt_ap ; 
    ...
    function void build_phase (uvm_phase phase);
        ...
        if(!uvm_config_db#(wrapper_object)::get(this,"","wrapper_CFG",obj)) 
    ...
    function void connect_phase(uvm_phase phase);
        ...
        drv.wrapper_vif = obj.wrapper_vif;
        mon.wrapper_vif = obj.wrapper_vif;
    endfunction
