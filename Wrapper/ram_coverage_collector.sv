...
covergroup cvr_gp;
    ...
    din_trans:coverpoint seq_item_cov.din[9:8] {
        bins din_98_trans = (2'b00[*13] => 2'b01[*13]  => 2'b10[*13]  => 2'b11[*13] );
    }
    // rx_valid
...
task run_phase(uvm_phase phase);
    ...
    forever begin
        ...
        // debug print to help investigate why the din_trans (00=>01=>10=>11) bin never hits
    $display("[RAM_COV] t=%0t din=%b", $time, seq_item_cov.din[9:8]);
    $display("[RAM_COV] rx=%0d tx=%0d", seq_item_cov.rx_valid, seq_item_cov.tx_valid);
        cvr_gp.sample();
    end
